...
const AboutMain: React.FC<Aboutpage> = ({ mainHeading, subHeading, aboutImage }) => {
  return (
    <>
      <p className="w-[90%] md:w-[85%] xl:w-[70%] font-medium  text-[4rem] md:text-[6rem] leading-none">
        {mainHeading}
      </p>
      <div className="flex flex-1 flex-wrap w-[90%] md:w-[85%] xl:w-[70%] lg:flex-nowrap gap-5">
